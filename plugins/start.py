...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        silentbots = [] # List to keep track of sent messages
        ...
        for msg in messages:
            ...
            try:
                silentbot = await msg.copy(chat_id=message.from_user.id, caption = caption, parse_mode = ParseMode.HTML, reply_markup = reply_markup, protect_content=PROTECT_CONTENT)
                # await asyncio.sleep(0.5)
                silentbots.append(silentbot)
